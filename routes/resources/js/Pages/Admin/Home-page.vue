                        ...
                        <div class="grid grid-cols-12 gap-x-6">
                              <div class="col-span-12">
                                    <div class="card welcome-banner bg-primary-800">
                                          <div
                                                class="absolute opacity-50 inset-0 z-10 bg-right-bottom bg-[length:100%] bg-no-repeat bg-[url('admin/assets/images/widget/img-dropbox-bg.svg')]">
                                          </div>
                                          <div class="card-body relative z-20">
                                                <div class="grid grid-cols-12 gap-6">
                                                      <div class="col-span-12 sm:col-span-6">
                                                            <div class="p-4">
                                                                  <h2 class="text-slate-300 text-4xl font-bold">Welcome {{ user.name }} to {{ appName }}</h2>
                                                                  <p class="text-white my-5">Lorem ipsum</p>
                                                            </div>
                                                      </div>
                                                      <div class="col-span-12 sm:col-span-6 text-center"><img
                                                                  src="admin/assets/images/widget/welcome-banner.png"
                                                                  alt="img" class="img-fluid w-[200px] max-w-full mx-auto">
                                                      </div>
                                                </div>
                                          </div>
                                    </div>
                                                ...
                                                <div class="flex items-center">
                                                      ...
                                                      <div class="shrink-0">
                                                            <div class="dropdown"><a
                                                                        ...
                                                                        href="index.html#" data-pc-toggle="dropdown"
                                                                        aria-haspopup="true" aria-expanded="false"><i
                                                                              class="ti ti-dots-vertical text-lg leading-none"></i></a>
                                                                  <div class="dropdown-menu dropdown-menu-end"><a
                                                                              class="dropdown-item"
                                                                              href="index.html#">Today</a> <a
                                                                              class="dropdown-item"
                                                                              href="index.html#">Weekly</a> <a
                                                                              class="dropdown-item"
                                                                              href="index.html#">Monthly</a></div>
                                                            </div>
                                                      </div>
                                                </div>
                                                <div class="bg-theme-bodybg dark:bg-themedark-bodybg p-3 mt-4 rounded-lg">
                                                      <div class="mt-3 grid grid-cols-12 gap-4">
                                                            ...
                                                            <div class="col-span-5">
                                                                  ...
                                                                  <p class="text-primary-500 mb-0"><i
                                                                              class="ti ti-arrow-up-right"></i> 30.6%
                                                                  </p>
                                                            </div>
                                                      </div>
                                                </div>
                                                            ...
                                                            <div
                                                                  ...
                                                                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                                        ...
                                                                        <path opacity="0.6"
                                                                              ...
                                                                              stroke-miterlimit="10" stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                        <path opacity="0.6" d="M8 13H12" stroke="#E58A00"
                                                                              stroke-width="1.5" stroke-miterlimit="10"
                                                                              stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                        <path opacity="0.6" d="M8 17H16" stroke="#E58A00"
                                                                              stroke-width="1.5" stroke-miterlimit="10"
                                                                              stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                  </svg>
                                                            ...
                                                            <div
                                                                  ...
                                                                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                                        ...
                                                                        <path d="M16 2V5" stroke="#2ca87f" stroke-width="1.5"
                                                                              stroke-miterlimit="10" stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                        <path opacity="0.4" d="M3.5 9.08984H20.5"
                                                                              stroke="#2ca87f" stroke-width="1.5"
                                                                              stroke-miterlimit="10" stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                        <path d="M21 8.5V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5Z"
                                                                              ...
                                                                              stroke-miterlimit="10" stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                        <path opacity="0.4" d="M15.6947 13.7002H15.7037"
                                                                              stroke="#2ca87f" stroke-width="2"
                                                                              stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                        <path opacity="0.4" d="M15.6947 16.7002H15.7037"
                                                                              stroke="#2ca87f" stroke-width="2"
                                                                              stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                        <path opacity="0.4" d="M11.9955 13.7002H12.0045"
                                                                              stroke="#2ca87f" stroke-width="2"
                                                                              stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                        <path opacity="0.4" d="M11.9955 16.7002H12.0045"
                                                                              stroke="#2ca87f" stroke-width="2"
                                                                              stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                        <path opacity="0.4" d="M8.29431 13.7002H8.30329"
                                                                              stroke="#2ca87f" stroke-width="2"
                                                                              stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                        <path opacity="0.4" d="M8.29395 16.7002H8.30293"
                                                                              stroke="#2ca87f" stroke-width="2"
                                                                              stroke-linecap="round"
                                                                              stroke-linejoin="round" />
                                                                  </svg>
                                          ...
                                          <div class="card-body">
                                                <div class="flex items-center justify-between">
                                                      ...
                                                      <div class="dropdown"><a
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end"><a
                                                                        class="dropdown-item" href="index.html#">Today</a> <a
                                                                        class="dropdown-item" href="index.html#">Weekly</a> <a
                                                                        class="dropdown-item" href="index.html#">Monthly</a>
                                                            </div>
                                                      </div>
                                                </div>
                                    ...
                                    <div class="card">
                                          ...
                                          <div class="card-body">
                                                <div class="mb-3">
                                                      ...
                                                      <div
                                                            class="w-full bg-theme-bodybg rounded-lg h-2 mb-4 dark:bg-themedark-bodybg">
                                                            <div class="bg-primary-500 h-full rounded-lg" role="progressbar"
                                                                  style="width: 50%" aria-valuenow="50" aria-valuemin="0"
                                                                  aria-valuemax="100"></div>
                                                      </div>
                                                </div>
                                                <div class="grid gap-3"><a href="index.html#" class="btn btn-link-secondary">
                                                            <div class="flex align-items-center">
                                                                  <div class="shrink-0"><span
                                                                              class="rounded-full w-2.5 h-2.5 inline-block bg-warning-500"></span>
                                                                  </div>
                                                                  <div class="grow-1 mx-2">
                                                                        <p class="mb-0 grid text-left"><span
                                                                                    class="truncate w-full">Horizontal
                                                                                    Layout</span></p>
                                                                  </div>
                                                                  <div
                                                                        class="badge inline-flex gap-1 bg-secondary-500/10 text-secondary-500 text-sm">
                                                                        <i class="ti ti-paperclip text-sm"></i> 2
                                                                  </div>
                                                            </div>
                                                      </a><a href="index.html#" class="btn btn-link-secondary">
                                                            <div class="flex align-items-center">
                                                                  <div class="shrink-0"><span
                                                                              class="rounded-full w-2.5 h-2.5 inline-block bg-warning-500"></span>
                                                                  </div>
                                                            ...
                                                            <div class="flex align-items-center">
                                                                  ...
                                                                  <div class="grow-1 mx-2">
                                                                        <p class="mb-0 grid text-left"><span
                                                                                    class="truncate w-full">Figma Auto
                                                                                    Layout</span></p>
                                                                  </div>
                                                            </div>
                                                      </a></div>
                                                <div class="grid mt-3"><button
                                                            class="btn btn-primary flex items-center justify-center gap-3"><i
                                                ...
                                                <div class="grid grid-cols-12 gap-6 mt-3">
                                                      ...
                                                      <div class="col-span-12 md:col-span-6 xl:col-span-4 self-center">
                                                            <div class="grid"><button
                                                                        class="btn btn-primary dflex align-center justify-center"><i
                                          ...
                                          <div class="card-body">
                                                ...
                                                <div class="flex items-center justify-between mt-4">
                                                      <div
                                                            ...
                                                            <img src="admin/assets/images/user/avatar-1.jpg" alt="user-image"
                                                                  class="avtar"> <img
                                                                  src="admin/assets/images/user/avatar-3.jpg" alt="user-image"
                                                                  class="avtar"> <img
                                                                  src="admin/assets/images/user/avatar-4.jpg" alt="user-image"
                                                                  class="avtar"> <img
                                                                  src="admin/assets/images/user/avatar-5.jpg" alt="user-image"
                                                                  class="avtar"> <span
                                    ...
                                    <div class="card">
                                          <div class="card-body border-bottom pb-0">
                                                ...
                                                <ul
                                                      ...
                                                      <li class="group active"><a href="javascript:void(0);"
                                                                  data-pc-toggle="tab" data-pc-target="tran-1"
                                                                  ...
                                                                  Transaction</a></li>
                                                      <li class="group"><a href="javascript:void(0);" data-pc-toggle="tab"
                                                                  ...
                                                                  <div class="flex items-center">
                                                                        ...
                                                                        <div class="grow ltr:ml-3 rtl:mr-3">
                                                                              <div class="grid grid-cols-12 gap-2">
                                                                                    ...
                                                                                    <div
                                                                                          class="col-span-6 ltr:text-right rtl:text-left">
                                                                                          <h6 class="mb-1">$210,000</h6>
                                                                                          <p class="text-danger-500 mb-0"><i
                                                                                                      class="ti ti-arrow-down-left"></i>
                                                                                                10.6%</p>
                                                                                    </div>
                                                                              </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="grow ltr:ml-3 rtl:mr-3">
                                                                              <div class="grid grid-cols-12 gap-2">
                                                                                    ...
                                                                                    <div
                                                                                          ...
                                                                                          <p class="text-success-500 mb-0"><i
                                                                                                      class="ti ti-arrow-down-right"></i>
                                                                                                30.6%</p>
                                                                                    </div>
                                                                              </div>
                                                                        </div>
                                          ...
                                          <div class="card-footer">
                                                <div class="grid grid-cols-12 gap-2">
                                                      <div class="col-span-12 md:col-span-6">
                                                            <div class="grid"><button
                                                                        class="btn btn-outline-secondary grid"><span
                                                                              class="truncate w-full">View all Transaction
                                                                              History</span></button></div>
                                                      </div>
                                                      <div class="col-span-12 md:col-span-6">
                                                            <div class="grid"><button class="btn btn-primary grid"><span
                                                                              class="truncate w-full">Create new
                                                                              Transaction</span></button></div>
                                                      </div>
                                                </div>
                                          </div>
                                    </div>
                                    ...
                                    <div class="card">
                                          <div class="card-body">
                                                ...
                                                <div class="grid grid-cols-12 gap-3 mt-4">
                                                      <div class="col-span-12 sm:col-span-6">
                                                            <div
                                                                  class="p-4 rounded-lg bg-theme-bodybg dark:bg-themedark-bodybg">
                                                                  <p class="mb-1 relative inline-flex items-center gap-2">
                                                                        <span
