...
<template>
            <form @submit.prevent="submit">
                  <div class="modal fade" id="addEmployeeModal"  tabindex="-1"
                        aria-labelledby="createprojectLabel" aria-hidden="true" :class="{ show: showModal }"
                              ...
                              <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                          <div class="deadline-form">
                                                ...
                                                <div class="row g-3 mb-3">
                                                      <div class="col-sm-6">
                                                            ...
                                                            <TextInput type="text" v-model="form.employee_identity"
                                                                  ...
                                                                  autofocus autocomplete="employeeId" />
                                                            <InputError class="mt-2"
                                                ...
                                                <div class="row g-3 mb-3">
                                                      <div class="col">
                                                            ...
                                                            <InputError class="mt-2"
                                                                  :message="form.errors.job_title_name" />
                                                      </div>
                                                      <div class="col">
                                          ...
                                          <div class="mb-3">
                                                ...
                                                <TextInput type="file" v-model="form.employee_image"
                                                      id="employee_image" />
