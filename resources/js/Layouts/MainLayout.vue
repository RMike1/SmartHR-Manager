                    ...
                    <ul class="menu-list flex-grow-1 mt-3">
                        ...
                        <li class="collapsed">
                            ...
                            <ul class="sub-menu collapse" id="emp-Components">
                                ...
                                <li><a class="ms-link" href="employee-profile.html"> <span>Members Profile</span></a>
                                </li>
                            ...
                            <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                                <div class="d-flex">
                                    ...
                                    <div class="avatar-list avatar-list-stacked px-3">
                                        <img class="avatar rounded-circle" src="admin/assets/images/xs/avatar2.jpg"
                                            alt="">
                                        <img class="avatar rounded-circle" src="admin/assets/images/xs/avatar1.jpg"
                                            alt="">
                                        <img class="avatar rounded-circle" src="admin/assets/images/xs/avatar3.jpg"
                                            alt="">
                                        <img class="avatar rounded-circle" src="admin/assets/images/xs/avatar4.jpg"
                                            alt="">
                                        <img class="avatar rounded-circle" src="admin/assets/images/xs/avatar7.jpg"
                                            alt="">
                                        <img class="avatar rounded-circle" src="admin/assets/images/xs/avatar8.jpg"
                                            alt="">
                                                    ...
                                                    <ul class="list-unstyled list mb-0">
                                                        ...
                                                        <li class="py-2 mb-1 border-bottom">
                                                            <a href="javascript:void(0);" class="d-flex">
                                                                ...
                                                                <div class="flex-fill ms-2">
                                                                    <p class="d-flex justify-content-between mb-0 ">
                                                                        <span class="font-weight-bold">Diane
                                                                            Fisher</span>
                                                                        <small>13MIN</small>
                                                                    </p>
                                                        ...
                                                        <li class="py-2 mb-1 border-bottom">
                                                            <a href="javascript:void(0);" class="d-flex">
                                                                ...
                                                                <div class="flex-fill ms-2">
                                                                    <p class="d-flex justify-content-between mb-0 ">
                                                                        <span class="font-weight-bold">Andrea
                                                                            Gill</span>
                                                                        <small>1HR</small>
                                                                    </p>
                                                        ...
                                                        <li class="py-2 mb-1 border-bottom">
                                                            <a href="javascript:void(0);" class="d-flex">
                                                                <img class="avatar rounded-circle"
                                                                    src="admin/assets/images/xs/avatar5.jpg" alt="">
                                                                <div class="flex-fill ms-2">
                                                                    <p class="d-flex justify-content-between mb-0 ">
                                                                        <span class="font-weight-bold">Diane
                                                                            Fisher</span>
                                                        ...
                                                        <li class="py-2 mb-1 border-bottom">
                                                            <a href="javascript:void(0);" class="d-flex">
                                                                <img class="avatar rounded-circle"
                                                                    src="admin/assets/images/xs/avatar6.jpg" alt="">
                                                                <div class="flex-fill ms-2">
                                                                    <p class="d-flex justify-content-between mb-0 ">
                                                                        <span class="font-weight-bold">Andrea
                                                                            Gill</span>
                                                        ...
                                                        <li class="py-2">
                                                            <a href="javascript:void(0);" class="d-flex">
                                                                <img class="avatar rounded-circle"
                                                                    src="admin/assets/images/xs/avatar7.jpg" alt="">
                                                                <div class="flex-fill ms-2">
                                                                    <p class="d-flex justify-content-between mb-0 ">
                                ...
                                <div
                                    ...
                                    <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button"
                                        ...
                                        <img class="avatar lg rounded-circle img-thumbnail"
                                            src="admin/assets/images/profile_av.png" alt="profile">
                                    </a>
                                    <div
                                        ...
                                        <div class="card border-0 w280">
                                            ...
                                            <div class="list-group m-2 ">
                                                ...
                                                <button @click="logout"
                                                    class="list-group-item list-group-item-action border-0 "><i
                                                        class="icofont-logout fs-6 me-3"></i>Signout
                                                </button>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-12">
                                        <div class="card bg-primary">
                                            <div class="card-body row">
                                                ...
                                                <div class="col">
                                                    <img class="img-fluid" src="admin/assets/images/interview.svg"
                                                        alt="interview">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="flex-grow-1">
                                                    <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                                        <div class="d-flex align-items-center flex-fill">
                                                            <img class="avatar lg rounded-circle img-thumbnail"
                                                                src="admin/assets/images/lg/avatar2.jpg" alt="profile">
                                                    ...
                                                    <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                                        <div class="d-flex align-items-center flex-fill">
                                                            <img class="avatar lg rounded-circle img-thumbnail"
                                                                src="admin/assets/images/lg/avatar9.jpg" alt="profile">
                                                            <div class="d-flex flex-column ps-3">
                                                    ...
                                                    <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                                        <div class="d-flex align-items-center flex-fill">
                                                            <img class="avatar lg rounded-circle img-thumbnail"
                                                                src="admin/assets/images/lg/avatar12.jpg" alt="profile">
                                                            <div class="d-flex flex-column ps-3">
                                                    ...
                                                    <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                                        <div class="d-flex align-items-center flex-fill">
                                                            <img class="avatar lg rounded-circle img-thumbnail"
                                                                src="admin/assets/images/lg/avatar8.jpg" alt="profile">
                                                            <div class="d-flex flex-column ps-3">
                                                    ...
                                                    <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                                        <div class="d-flex align-items-center flex-fill">
                                                            <img class="avatar lg rounded-circle img-thumbnail"
                                                                src="admin/assets/images/lg/avatar7.jpg" alt="profile">
                                                            <div class="d-flex flex-column ps-3">
                                                    ...
                                                    <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                                        <div class="d-flex align-items-center flex-fill">
                                                            <img class="avatar lg rounded-circle img-thumbnail"
                                                                src="admin/assets/images/lg/avatar3.jpg" alt="profile">
                                                            <div class="d-flex flex-column ps-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3 align-items-center">
                                            <div class="col-md-12 col-lg-4 col-xl-4 col-xxl-2">
                                                <p>You have 140 <span class="fw-bold">influencers </span> in your
                                                    company.
                                                </p>
                                                        ...
                                                        <div class="card shadow">
                                                            <div
                                                                ...
                                                                <img class="avatar lg rounded-circle img-thumbnail mx-auto"
                                                                    src="admin/assets/images/lg/avatar2.jpg"
                                                                    alt="profile">
                                                    ...
                                                    <div class="col">
                                                        <div class="card shadow">
                                                            <div
                                                                class="card-body text-center d-flex flex-column justify-content-center">
                                                                <img class="avatar lg rounded-circle img-thumbnail mx-auto"
                                                                    src="admin/assets/images/lg/avatar5.jpg"
                                                                    alt="profile">
                                                    ...
                                                    <div class="col">
                                                        <div class="card shadow">
                                                            <div
                                                                class="card-body text-center d-flex flex-column justify-content-center">
                                                                <img class="avatar lg rounded-circle img-thumbnail mx-auto"
                                                                    src="admin/assets/images/lg/avatar8.jpg"
                                                                    alt="profile">
                                                    ...
                                                    <div class="col">
                                                        <div class="card shadow">
                                                            <div
                                                                class="card-body text-center d-flex flex-column justify-content-center">
                                                                <img class="avatar lg rounded-circle img-thumbnail mx-auto"
                                                                    src="admin/assets/images/lg/avatar9.jpg"
                                                                    alt="profile">
                                                    ...
                                                    <div class="col">
                                                        <div class="card shadow">
                                                            <div
                                                                class="card-body text-center d-flex flex-column justify-content-center">
                                                                <img class="avatar lg rounded-circle img-thumbnail mx-auto"
                                                                    src="admin/assets/images/lg/avatar12.jpg"
                                                                    alt="profile">
                                                    ...
                                                    <div class="col">
                                                        <div class="card shadow">
                                                            <div
                                                                class="card-body text-center d-flex flex-column justify-content-center">
                                                                <img class="avatar lg rounded-circle img-thumbnail mx-auto"
                                                                    src="admin/assets/images/lg/avatar3.jpg"
                                                                    alt="profile">
