...
<template>
    <div class="sidebar px-4 py-4 py-md-5 me-0">
        <div class="d-flex flex-column h-100">
            <Link :href="route('dashboard')" class="mb-0 brand-icon">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                <li class="collapsed">
                    <a class="m-link" :class="{ 'active': $page.url === '/dashboard' }" data-bs-toggle="collapse"
                    ...
                    <ul class="sub-menu collapse show" id="dashboard-Components">
                        <li>
                            <Link class="ms-link" :class="{ 'active': $page.component === 'Dashboard' }"
                                :href="route('dashboard')"> <span>Hr Dashboard</span></Link>
                        </li>
                    </ul>
                </li>
                <li class="collapsed">
                ...
                <li class="collapsed">
                    <a class="m-link" :class="{ 'active': $page.component === 'Employee/Index' }" data-bs-toggle="collapse" data-bs-target="#emp-Components" href="#">
                    ...
                    <ul class="sub-menu collapse show" id="emp-Components">
                        <li>
                            <Link class="ms-link" :class="{ 'active': $page.component === 'Employee/Index' }" :href="route('employee')">
                                <span>Members</span>
                            </Link>
                        </li>
